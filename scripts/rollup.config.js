...
function copyFiles() {
	...
	prepareForCopy.push(
		...
		{
			from: jetpack.path('src', 'cef'),
			to: jetpack.path(buildOutput, 'client_packages', 'cef')
		}
	);
...
const generateConfig = (options = {}) => {
	...
	jetpack.remove(jetpack.path(buildOutput, 'client_packages', 'cef'));
	copy(jetpack.path('src', 'cef'), jetpack.path(buildOutput, 'client_packages', 'cef'));
	copy(jetpack.path('.env'), jetpack.path(buildOutput, '.env'));
