...
function onButtonClick(button) {
	if (dialog_name != null && dialog_name != "") {
		...
		const response = { dialogName: dialog_name, clickedButtonId: button, selecetedItemId: list_selected, inputValue: inputtext_value, passwordValue: inputpassword_value };
		mp.trigger(dialog_name, JSON.stringify(response));
	}
}
